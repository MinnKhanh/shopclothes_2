...
@section('content')
    ...
    <div class="col-12">
        ...
        <div class="custom-datatable bg-light p-30 table-responsive">
           <form id="formcategory" class="" action="{{ route('admin.type.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        @if (isset($isedit))
        ...
        <div class="col-md-6 form-group mb-4">
            ...
            <input class = "form-control shadow-none rounded-0" id="namecategory" type="text" name="name" value={{isset($type)?$type['name']:''}}>
            <span class = "text-danger errorname"></span>
        </div>
            <div class="col-md-6 form-group">
            <label>Ảnh</label>
            <input class = "form-control shadow-none rounded-0  file-img" name="photo" id="photocategory" type = "file">
            <span class ="text-danger errorphoto"></span>
            </div>
            <div class="col-md-6 form-group">
            <img style="width:200px; height:100%;" src="{{isset($type)?asset('storage/'.$type['img'][0]['path']):''}}" class="imgchange" id="imgcategory"/>
         </div>

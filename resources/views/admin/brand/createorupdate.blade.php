...
@section('content')
    ...
    <div class="col-12">
        ...
        <div class="custom-datatable bg-light p-30 table-responsive">
           <form id="formcategory" class="" action="{{ route('admin.brand.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        @if (isset($isedit))
        ...
        <div class="row col-12">
            <div class="col-md-6 form-group mb-4">
                ...
                <input class = "form-control shadow-none rounded-0" id="namecategory" type="text" name="name" value={{isset($brand)?$brand['name']:''}}>
        ...
        <div class="col-md-6 form-group">
            ...
            <div class="col-md-6">
                <img style="width:200px; height:100%;" src="{{isset($brand)?asset('storage/'.(isset($brand['img'][0])?$brand['img'][0]['path']:'')):''}}" class="imgchange" id="imgcategory"/>
            </div>
         </div>
        <div class="col-md-6 form-group mb-4">
            <label>Mô tả</label>

        ...
        <div class="bg-light p-30">
            ...
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input name="name" id="tensp" class = "form-control shadow-none rounded-0" value="{{isset($edit)?$product['name']:old('name')}}" placeholder = "Áo sơ mi dài tay khử mùi">
                    @if($errors->has('name'))
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input name="description" id="" class = "form-control shadow-none rounded-0" value="{{isset($edit)?$product['description']:old('description')}}" placeholder = "Áo sơ mi dài tay với chất liệu khử mùi, co giãn tự nhiên">
                ...
                <div class="col-md-6 form-group row">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        @endphp --}}
                        <img style="width:100px; height:100%;" class="imgchange" src="{{isset($edit)?asset('storage/'.$product['img'][0]['path']):''}}" id="imgtype"/>
                    </div>
                </div>
                 <div class="col-md-4 form-group">
                    <label>Nhãn Hiệu</label>
                    <select name="brand" class = "form-control" id="brand" data-old="{{isset($edit)?$product['brand']:old('brand')}}">
                         @if(old('brand') != NULL|| isset($edit))
                        <option value="{{isset($edit)?$product['brand']:old('brand')}}">{{$brand->where('id', isset($edit)?$product['brand']:intval(old('brand')))->first()->name}}</option>
                         @endif
                    </select>
                     @if($errors->has('brand'))
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control" name="featured" id="NoiBat">
                        <option value=0 {{(isset($edit)?$product['featured']:old('featured'))==0?'selected':''}}>Có</option>
                        <option value=1 {{(isset($edit)?$product['featured']:old('featured'))==1?'selected':''}}>Không</option>
                    </select>
...
@section('modal')
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="modal-body" id="formtype" action="{{ route('admin.type.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-12 row form-group">
            <div class="col-md-8 form-group">
            <label>Ảnh</label>
            <input class = "form-control shadow-none rounded-0  file-img" name="photo" id="phototype" type = "file">
 ...
 <div class="modal fade" id="modalcategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class="modal-body" id="formcategory" action="{{ route('admin.category.store') }}" method="post" enctype="multipart/form-data">
        @csrf
         <div class="col-md-12 form-group">
                    <label>Phân loại chính</label>
                    <select name="type" id="type_cate" style="width: 100%" class="form-control shadow-none rounded-0">
        ...
        <div class="col-md-12 form-group mb-4">
            <label>Tên Loại</label>
            <input class = "form-control shadow-none rounded-0" id="namecategory" name="name" type = "text" disabled>
            <span class = "text-danger errorname"></span>
        </div>
         <div class="col-md-12 row form-group">
            <div class="col-md-8 form-group">
            <label>Ảnh</label>
            <input class = "form-control shadow-none rounded-0  file-img" name="photo" id="photocategory" type = "file" disabled>
            <span class ="text-danger errorphoto"></span>
            </div>
            <div class="col-md-4 form-group">

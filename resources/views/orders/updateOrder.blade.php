                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Name</label>
                            <input class="form-control name" name="name" type="text" placeholder="John" value="{{$order->name}}">
                              @if($errors->has('name'))
                    ...
                    @endif
                        ...
                        <div class="col-md-6 form-group">
                            <label>Phone</label>
                            <input class="form-control phone" name="phone" type="text" placeholder="Doe" value="{{$order->phone}}">
                              @if($errors->has('phone'))
                    ...
                    @endif
                        ...
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input class="form-control email" name="email" type="text" placeholder="example@email.com" value="{{$order->email}}">
                              @if($errors->has('email'))
                    ...
                    @endif
                        ...
                        <div class="col-md-6 form-group">
                            <label>Address</label>
                            <input class="form-control address" name="address" type="text" placeholder="+123 456 789" value="{{$order->address}}">
                    ...
                    @endif
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control code" name="zip_code" type="text" placeholder="123" value="{{$order->code}}">
                              @if($errors->has('code'))
                ...
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        <div class="d-flex justify-content-between mt-2">
                            <h5>Total</h5>
                             <h5><span class="total">{{($order['price']*(1-$order['discount']/100))-$order['ship']}}</span>Đ</h5>
                        </div>
                    </div>
                </div>
                 <button class="btn btn-block btn-primary font-weight-bold py-3" type="submit">Cập Nhật</button>
                 <a href="{{route('orders.reject')}}" class="btn btn-block btn-primary font-weight-bold py-3" type="button">Hủy</a>
            </div>
  ...
  <tbody>
   @forelse ($orderdetail as $item)
       <tr class='text-center itemproduct'>
            ...
            <td> <a class="delete" style="margin-right:10px" data-id={{$item['id_order']}} data-idPro={{$item['id_product']}} data-size={{$item['size']}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
